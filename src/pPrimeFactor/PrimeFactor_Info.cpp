...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pPrimeFactor application is used for calculating all prime");
  blk("  numbers within a given range                                  ");
  blk("                                                                ");
  blk("                                                                ");
  blk("                                                                ");
}
...
void showExampleConfigAndExit()
{
  ...
  blk("}                                                               ");
  blk("                                                                ");
  blk("Set NUM_VALUE to a uint64_t compatible number, and read from PRIME_RESULT");
  blk("                                                                ");
  exit(0);
}
...
void showInterfaceAndExit()
{
  ...
  blk("SUBSCRIPTIONS:                                                  ");
  blk("------------------------------------                            ");
  blk("  NUM_VALUE = 'STRING OF uint64_t NUMBER'   ");
  blk("                                                                ");
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");
  blk("  PRIME_RESULT = 'TODO insert sample'      ");
  blk("                                                                ");
  exit(0);
}
