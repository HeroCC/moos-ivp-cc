 ...
 * This version will not remove elements when they are read
 ...
 *
 * @param outbuf destination buffer to store elements in
 * @return number of elements retrieved
 */
template <typename T>
